//Задача 1: Напишіть функцію, яка буде виконувати js код який передали
// в функцію через аргумент в форматі тексту

// Створюємо функцію з назвою calculateExpression,
// яка приймає один аргумент expression
...
// Задача 2: Напишіть функцію, яка приймає рядок та повертає число
// з цього рядка або повідомлення про помилку.

// Створюємо функцію з назвою getNumberFromString,
// яка приймає один аргумент s
function getNumberFromString(s) {
  // Використовуємо функцію parseFloat для того,
  // щоб спробувати отримати число з рядка
  // Перевіряємо, чи є отримане значення числом за допомогою isNaN
  // Якщо значення не є числом, повертаємо текст
...
// Задача 3: Напишіть функцію, яка приймає рядок та повертає
// ціле число з цього рядка або повідомлення про помилку.

// Створюємо функцію з назвою getIntegerFromString, яка приймає один аргумент s
function getIntegerFromString(s) {
  // Використовуємо функцію parseInt для того, щоб спробувати
  // отримати ціле число з рядка
  // Перевіряємо, чи є отримане значення числом за допомогою isNaN
  // Якщо значення не є числом, повертаємо текст
...
function isNumberFinite(num) {
  // Використовуємо вбудовану функцію isFinite, щоб перевірити,
  // чи є введене число скінченним.
  // Ця функція повертає true, якщо число є скінченним, і false,
  // якщо число є нескінченним або не є числом.
...
console.log("isNumberFinite(100)", isNumberFinite(100));
// Виведе "The number is finite."
console.log("isNumberFinite(Infinity)", isNumberFinite(Infinity));
// Виведе "The number is not finite."
...
function isValueNaN(value) {
  // Використовуємо вбудовану функцію isNaN, щоб перевірити,
  // чи є введене значення NaN.
...
// Створюємо функцію з назвою encodeURLComponent,
// яка приймає один аргумент - urlComponent
function encodeURLComponent(urlComponent) {
  // Використовуємо вбудовану функцію encodeURIComponent,
  // щоб закодувати введений компонент URL.
  // Ця функція повертає закодований компонент URL,
  // замінивши небезпечні символи на їх процентне кодування.
  // Повертаємо закодований компонент URL.

  let y = encodeURIComponent(urlComponent);
...
function encodeURL(url) {
  ...
  // Ця функція повертає закодований URL, замінивши небезпечні символи
  // на їх процентне кодування.
...
// Створюємо функцію з назвою decodeURLComponent,
// яка приймає один аргумент - urlComponent
function decodeURLComponent(urlComponent) {
  // Використовуємо вбудовану функцію decodeURIComponent,
  // щоб декодувати введений закодований компонент URL.
  // Ця функція повертає декодований компонент URL,
  // замінивши процентне кодування символів на їх реальні значення.
  // Повертаємо декодований компонент URL.

  let d = decodeURIComponent(urlComponent);
...
function decodeURL(url) {
  // Використовуємо вбудовану функцію decodeURI,
  // щоб декодувати введений закодований URL.
  // Ця функція повертає декодований URL,
  // замінивши процентне кодування символів на їх реальні значення.
